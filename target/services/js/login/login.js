...
function login(){
	...
	$.ajax({
		...
		success: function(data, textStatus, jqXHR)
		{
			...
			document.getElementById("subButton").value="Login";
			
			document.getElementById("productFormResponse").innerHTML="Login Sucess";
...
function update(){
	...
	$.ajax({
		url : "/Spring-OODD/standalone/edit",
		type: "POST",
		data : JSON.stringify(formData),
		beforeSend: function(xhr) {
			xhr.setRequestHeader("Accept", "application/json");
...
function loadObjects(){
	$.ajax({
		url : "/Spring-OODD/standalone/findAll",
		type: "GET",
		data : {},
		dataType: "json",
		success: function(data, textStatus, jqXHR)
...
function deleteObject(productid){
	...
	delurl="/Spring-OODD/standalone/remove/"+productid;
	$.ajax({
		url : delurl,
		type: "POST",
		data : productForm,
...
function editObject(productid){
	editurl="/Spring-OODD/standalone/findById/"+productid;
	var productForm={id:productid};
	$.ajax({
		url : editurl,
		type: "GET",
